...
const baseUrl = hasSupabase ? `${base}/functions/v1` : '';
...
// ---------- Public API ----------
export const PortfolioAPI = hasSupabase ? {
  ...
  holdings: async () => enrichHoldings(),
  allocation: async () => mockAllocation(),
  performance: async () => mockPerformance(),
